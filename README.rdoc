...
backup profiles, auto cron updating and upload to remote servers through FTP/SSH
or archive sending to an email address.
...
To manually run a backup profile:

  rake backup PROFILE=my_profile

To update the crontab according to your schedule.rb :

  rake update_crontab

If you only want to show the crontab lines :
